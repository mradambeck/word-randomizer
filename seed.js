...
// simply run: `node seed.js` from the root of this text folder.
...
textList.push({
  ...
  github_link: 'https://github.com/mradambeck/text-01',
...
db.Text.remove({}, function(err, texts){
  ...
  db.Text.create(textList, function(err, texts){
    if (err) { return console.log('ERROR', err); }
    console.log("all texts:", texts);
    console.log("created", texts.length, "texts");
    process.exit();
  });
